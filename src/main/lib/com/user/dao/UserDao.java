...
public class UserDao {
	...
	private String jdbcPassword = "@jayradhekrishna123";

	private static final String INSERT_USER_SQL = "INSERT INTO users" + "(u_name,email,phone,u_address,u_role) VALUES"
			+ "(?,?,?,?,?);";
